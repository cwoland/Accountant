...
import {
  ...
  ShoppingCart, Sparkles, User, LogOut, Wallet,
} from 'lucide-react';
...
const links = [
  ...
  { to: '/ai',           icon: <Sparkles size={18} />,        label: 'ИИ-советник' },
];
          ...
          >
            {({ isActive }) => (
              <>
                ...
                <span style={{ color: isActive ? 'var(--accent-2)' : 'inherit' }}>
                  {icon}
                </span>
                {label}
                {to === '/ai' && (
      ...
      <div style={{ borderTop: '1px solid var(--border)', padding: '12px 0', display: 'flex', flexDirection: 'column', gap: 2 }}>
        ...
        >
          <div style={{
            ...
            display: 'flex', alignItems: 'center', justifyContent: 'center',
            fontSize: '0.7rem', fontWeight: 700, color: 'var(--accent-2)',
            flexShrink: 0,
          }}>
            {user?.avatar
